<html>
    ...
    <body>
      ...
      <form class="" action="../controler/finCommande.ctrl.php" method="post">
        <fieldset>
          <h3>Montant total de la commande : <?=$_GET['prix']?>€</h3>
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="nom">Numéro de carte</span>
            </div>
            <input type="text" name="nom" class="form-control" aria-label="Default" aria-describedby="numero" required>
          </div>
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" aria-label="Default" aria-describedby="code" name="code" required>
          </div>
